...
class CountdownTimerBoxPushBuilder(
    ...
    private suspend fun customizeViews() {
        ...
        ColorUtils.setRemoteViewBackgroundColor(largeLayout, R.id.txt_seconds, timeColor)
        ColorUtils.setRemoteViewBackgroundColor(largeLayout, R.id.txt_minutes, timeColor)
        ColorUtils.setRemoteViewBackgroundColor(largeLayout, R.id.txt_hours, timeColor)
        ColorUtils.setRemoteViewBackgroundColor(smallLayout, R.id.txt_seconds, timeColor)
        ColorUtils.setRemoteViewBackgroundColor(smallLayout, R.id.txt_minutes, timeColor)
        ColorUtils.setRemoteViewBackgroundColor(smallLayout, R.id.txt_hours, timeColor)
